...
def get_options(args=None) -> argparse.Namespace:
    def color(arg: str) -> Tuple[Tuple[int, int, int], str]:
        ...
        if hex_groups is not None:
            ...
            l = len(match)
            rgb = [int(match[l//3*i:l//3*(i+1)], 16) for i in range(3)]
    ...
    def resolution(arg: str) -> Tuple[int, int]:
        ...
        if any(dimension < 200 for dimension in res):
    ...
    ret.add_argument('-c', '--color', default=((255, 105, 180), 'hotpink'),
                     type=color, help='#Hex / R,B,G / name of color')
